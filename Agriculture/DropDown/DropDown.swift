...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
	...
	public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		if let cellConfiguration = cellConfiguration {
            ...
            {
                print("JObsite print error")
//                let objjobSiteLocBO : JobSiteLocations = dataSource[indexPath.row] as! JobSiteLocations
//                cell.optionLabel.text = objjobSiteLocBO.strLLocationName
	...
	public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else
        {
            print("JObsite print error")
//            let objjobSiteLocBO : JobSiteLocations = dataSource[indexPath.row] as! JobSiteLocations
//            selectionAction?(selectedRowIndex!, objjobSiteLocBO.strLLocationName!)
